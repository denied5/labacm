...
void init() {
	a[0][0] = 50;	a[0][1] = 2;	a[0][2] = 3; a[0][3] = 4;		b[0] = 79;
	a[1][0] = 3;	a[1][1] = 20;	a[1][2] = 1; a[1][3] = -4; 		b[1] = 30;
	a[2][0] = 2;    a[2][1] = 2;    a[2][2] = 35; a[2][3] = 2;	    b[2] = 119;
	a[3][0] = 1;	a[3][1] = 0;	a[3][2] = 1; a[3][3] = 90;		b[3] = 364;
}
